...
const NotificationReplyModerator = ({ notification, currentAuthUsername, read, onClick, isModerator }) => {
...
NotificationReplyModerator.propTypes = {
  read: PropTypes.bool,
...
NotificationReplyModerator.defaultProps = {
  read: false,
  notification: {},
  isModerator: {},
  currentAuthUsername: '',
...
export default NotificationReplyModerator;
