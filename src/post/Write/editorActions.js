    ...
    dispatch({
      ...
      payload: {
        promise: getPermLink.then(permlink => {
          const newBody = isUpdating ? getBodyPatchIfSmaller(postData.originalBody, body) : body + `</li></ul></ol><br /><hr/><em>Open Source Contribution posted via <a href="https://utopian.io/${process.env.UTOPIAN_CATEGORY}/@${author}/${permlink}">Utopian.io</a></em><hr/>`;
