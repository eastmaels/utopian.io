...
export default class PrivacyPolicy extends React.PureComponent {
  ...
  render () {
    ...
    let { last_date_edit_privacy } = this.props.stats;
    let lastUpdateDate = moment(last_date_edit_privacy).format('MMMM Do, YYYY');
    
	return (<div className="main-panel PrivacyPolicy">
        ...
        02100, VAT #: IT01174530574 (“Utopian,” “we” or
			...
			<p>
				...
				a username, an email address, phone number), account preferences, and the
			...
			<p>
				...
				email address, and information about the product or service you are
				purchasing. Payments are processed by third-party payment processors (e.g.,
				Stripe and PayPal), so please refer to the applicable processor’s terms and
			...
			<p>
				...
				contests, sweepstakes or promotions, apply for a job, communicate with us
			...
			<p>
				...
				referral URLs, device information (e.g., device IDs), pages visited, links
			...
			<p>
				...
				improve the quality of our Services. For example, we store and retrieve
				information about your preferred language and other settings. On how you
			...
			<p>
				...
				You can revoke this consent at any time by changing the preferences on your
			...
			<p>
				...
				Your use of these features enables the sharing of certain information with
				...
				information about the purpose and scope of data collection and processing
				in connection with social sharing features, please visit the privacy
			...
			<ul>
				...
				<li>
					<p>
						Help protect the safety of Utopian and our users, which includes
						blocking suspected spammers, addressing abuse, and enforcing the
						Utopian user agreement and the Terms of Service;
					</p>
				</li>
				<li>
					<p>
			...
			<ul>
				<li>
					<p>
						When you submit a post or comment to the Services, visitors to and
						users of our Services will be able to see the content of your posts
						and comments, the username associated with your posts or comments,
						and the date and time you originally submitted the post or comment.
						Although some parts of the Services may be private or quarantined,
						they may become public and you should take that into consideration
				...
				<li>
					<p>
						...
						username, prior posts and comments, Steem Power, and how long you
						have been a member of the Services.
					</p>
				</li>
			</ul>
			...
			<ul>
				<li>
					<p>
						Except as it relates to advertisers and our ad partners, we may
						share information with vendors, consultants, and other service
						providers who need access to such information to carry out work for
						us;
					</p>
				</li>
				<li>
					<p>
						...
						offers, or other events or activities in connection with our
						Services, we may share information with entities that partner with
						us to provide these offerings;
					</p>
				</li>
				<li>
					<p>
						We may share information (and will attempt to provide you with
						prior notice, to the extent legally permissible) in response to a
				...
				<li>
					<p>
						...
						inconsistent with our user agreements, or other Utopian policies,
				...
				<li>
					<p>
						We may share information between and among Utopian, and its current
			...
			<p>
				...
				to better understand your use of the Services. These third parties may
				collect information sent by your computer, browser, or mobile device in
			...
			<p>
				...
				Services, but Utopian does not link to or provide your actual Utopian
				account details to these advertising partners. This means that Utopian does
				not share your individual account browsing habits with advertisers. Utopian
			...
			<p>
				...
				your account, your profile is no longer visible to other users and
				...
				deleting your account will still be visible to others, unless you delete
				such content. We may also retain certain information about you as required
				by law or for legitimate business purposes after you delete your account.
			...
			<p>
				...
				and third-party services that allow you to better understand cookies and
				how you can opt-out. You have the ability to opt out of having your web
			...
			<p>
				...
				on how to respond to web browsers’ DNT signals. When you have DNT enabled,
				we may still use information collected for analytics and measurement
				purposes or to otherwise provide our Services (e.g., Utopian.io buttons),
				but we will not load any third-party trackers. You may, however, opt out of
			...
			<p>
				31. We may change this Privacy Policy from time to time. If we do, we will
				let you know by revising the date at the top of the policy. If we make a
				...
				steemouncements, the front page of the Services or sending you a
				notification). We encourage you to review the Privacy Policy whenever you
				access or use our Services or otherwise interact with us to stay informed
